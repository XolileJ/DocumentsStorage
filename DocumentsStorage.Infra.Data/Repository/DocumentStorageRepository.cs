...
{
    public class DocumentStorageRepository<TEntity> : IDocumentStorageRepository<TEntity> where TEntity : class
    {
        protected DocumentContext Db;
        ...
        public DocumentStorageRepository(DocumentContext context)
        {
            Db = context;
